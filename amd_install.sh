...
case $opt in
	...
	wget --user=Gast http://192.168.0.6/Public/amdgpu-pro-20.50-1234663-ubuntu-18.04.tar.xz
        version="20.50-1234663-ubuntu-18.04";break
    ;;
    "21.10-1244864-ubuntu-18.04")
	wget --user=Gast http://192.168.0.6/Public/amdgpu-pro-21.10-1244864-ubuntu-18.04.tar.xz
        version="21.10-1244864-ubuntu-18.04";break
    ;;
	"21.20-1274019-ubuntu-18.04")
	wget --user=Gast http://192.168.0.6/Public/amdgpu-pro-21.20-1274019-ubuntu-18.04.tar.xz
